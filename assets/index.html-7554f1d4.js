import{_ as e,o as a,c as i,e as n}from"./app-9a7305ee.js";const r={},s=n(`<h1 id="ogg" tabindex="-1"><a class="header-anchor" href="#ogg" aria-hidden="true">#</a> OGG</h1><h2 id="ogg→kafka" tabindex="-1"><a class="header-anchor" href="#ogg→kafka" aria-hidden="true">#</a> ogg→kafka</h2><p>配置文件参考：<br><code>kafka.props</code></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>gg.handlerlist=kafkahandler 
