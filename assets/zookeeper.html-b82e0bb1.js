import{_ as e,o as a,c as s,e as n}from"./app-9a7305ee.js";const i={},d=n(`<h1 id="zookeeper安装配置" tabindex="-1"><a class="header-anchor" href="#zookeeper安装配置" aria-hidden="true">#</a> zookeeper安装配置</h1><hr><h2 id="_1-分配目录" tabindex="-1"><a class="header-anchor" href="#_1-分配目录" aria-hidden="true">#</a> 1.分配目录</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#创建安装目录</span>
